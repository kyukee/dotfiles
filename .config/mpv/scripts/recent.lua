-- commit hash: 0caacae (0caacae9bcd73802ec83e05637f0cfe723230be7)
local o = {
    ...
    ellipsis = false,
	-- Don't update history log when loading an entry from the menu
	write_log_on_load = false
}
